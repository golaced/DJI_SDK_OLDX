...
//  y[East]= drone_local_pos[East] -tar_drone_local_pos[East];
  ...
  yaw_use=Yaw;		
	...
	nav_Data.gps_ero_dis_lpf[2]=sqrt(nav_Data.gps_ero_dis_lpf[0]*nav_Data.gps_ero_dis_lpf[0]+nav_Data.gps_ero_dis_lpf[1]*nav_Data.gps_ero_dis_lpf[1])/1000.;
